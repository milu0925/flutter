...
class ThemeData with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<ButtonThemeData>(
        'buttonTheme', buttonTheme,
        level: DiagnosticLevel.debug));
    properties.add(DiagnosticsProperty<CardThemeData>('cardTheme', cardTheme,
        level: DiagnosticLevel.debug));
    ...
    properties.add(DiagnosticsProperty<DatePickerThemeData>(
        ...
        level: DiagnosticLevel.debug));
    properties.add(DiagnosticsProperty<DialogThemeData>(
    ...
    properties.add(DiagnosticsProperty<TabBarThemeData>(
